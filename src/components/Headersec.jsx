        ...
        <div className='max-w-[1341px] mx-auto px-3'>
            <div className="flex py-[15px] justify-between items-center ">
                ...
                <div className='flex items-center'>
                    ...
                    <li className="md:gap-[18px]  flex items-center pr-7 lg:pr-0">
                        <span
                            className={`${data === "xyz"
                                ? "right-100 z-10 px-3 border border-slate-50  bg-transparent"
                                : "px-1 right-0"
                                }  rounded-[8px] items-center max-[380px]:max-w-[280px]   w-full  top-[35px] sm:top-[8%] md:top-0 max-[640px]:w-[250px] max-[542px]:w-[81px] max-[374px]:hidden   max-[339px]:w-[81px] py-1 justify-between  lg:bg-transparent z-[2] transition-all ease-linear duration-300`}
                        >
                            <input
                                type="search"
                                placeholder="Search"
            ...
            <div className="max-w-[1320px] px-3 mx-auto pb-5 flex items-center justify-center flex-col" data-aos="zoom-in" data-aos-delay="1000">
                <h2 className='text-white font-Poppins sm:text-[48px] text-[40px] sm:text-5xl font-bold text-center sm:pt-28 pt-12 capitalize max-w-[908px] mx-auto sm:leading-normal'>Awesome Design Best Furniture For Your Interior</h2>
