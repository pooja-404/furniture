                    ...
                    <div className='flex flex-wrap flex-row -mx-3 '>
                        <div className='md:w-5/12 w-full px-3 z-[2]' data-aos="fade-up-right">
                            ...
                            <div className="flex gap-8 mt-8 relative justify-center">
                                <button onClick={() => arrowbtn?.current?.slickPrev()} className="rounded-[10px] w-[41px] h-[41px] flex items-center justify-center bg-white lg:absolute left-[65px] top-2 " >
                                ...
                                <button onClick={() => arrowbtn?.current?.slickNext()} className="rounded-[10px] w-[41px] h-[41px] flex items-center justify-center bg-white lg:absolute left-[2px] top-2" >
