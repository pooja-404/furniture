                ...
                <div className='max-w-[1320px]  px-3 mx-auto'>
                    <div className='flex flex-wrap flex-row -mx-3 '>
                        <div className='md:w-5/12 w-full px-3 z-[2]' data-aos="fade-up-right">
                            ...
                            <h2 className='text-[#243040] font-Poppins sm:text-[35px] text-2xl font-bold lg:max-w-[436px] pt-6 sm:leading-normal'>Buy trending furniture Products.</h2>
                            <p className='font-Poppins font-normal text-lg text-[#000000B2] lg:max-w-[422px] pt-5'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed faucibus, urna at pulvinar porta</p>
                            <div className="flex gap-8 mt-8 relative justify-center">
                                <button onClick={() => arrowbtn?.current?.slickPrev()} className="rounded-[10px] w-[41px] h-[41px] flex items-center justify-center bg-white absolute left-[65px] top-2 " >
                                ...
                                <button onClick={() => arrowbtn?.current?.slickNext()} className="rounded-[10px] w-[41px] h-[41px] flex items-center justify-center bg-white absolute left-[2px] top-2" >
